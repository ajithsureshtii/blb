...
public:
	...
	Linear(int party, sci::NetIO *io, bool prune);
	...
	void set_HE(size_t poly_modulus_degree, 
	...
	vector<Ciphertext> w_ln(HE* he, vector<Ciphertext> ln);
	...
	vector<vector<vector<Ciphertext>>> preprocess_softmax_s1_ct_ct(HE* he, const vector<Ciphertext> &matrix, const FCMetadata &data);
